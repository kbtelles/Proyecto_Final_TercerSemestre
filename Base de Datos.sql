...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `fk_empleados_puestos` FOREIGN KEY (`idPuesto`) REFERENCES `puestos` (`idPuesto`) ON UPDATE RESTRICT
...
INSERT INTO `empleados` VALUES (1,'Luis','Luch','Guatemala','5223','12345697',_binary '','2005-06-06',1,'2010-02-02','2010-01-01 15:30:00'),(2,'Luisa','Perez','Belice','415263','14795623',_binary '\0','2002-09-16',4,'2010-09-06','2009-12-31 23:59:59'),(4,'Abner','Lopez','Mexico','9562','1459632014',_binary '','2010-04-01',6,'2023-06-19','2023-07-25 17:15:10'),(6,'Melissa','Castillo','Guatemala','45123','321654972',_binary '\0','2004-06-06',7,'2022-09-09','2022-11-20 14:45:30');
...
INSERT INTO `puestos` VALUES (1,'Gerente'),(2,'Supervisor'),(3,'Cajero'),(4,'Vendedor'),(5,'Operario'),(6,'Contador'),(7,'Recepcionista'),(8,'Técnico'),(9,'Recursos Humanos\n\n'),(10,'Vendedor');
...
-- Dump completed on 2025-05-14 20:00:54
